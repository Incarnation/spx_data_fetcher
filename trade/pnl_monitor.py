...
def update_trade_pnl():
    ...
    now_iso = now_utc.isoformat()  # ← convert to string
    ...
    # 2️⃣ Fetch latest mid-prices for those legs (use root_symbol!)
    conds = " OR ".join(
        ...
        live_rows.append(
            {
                ...
                "leg_id": leg.leg_id,
                "timestamp": now_iso,  # ← string, not datetime
